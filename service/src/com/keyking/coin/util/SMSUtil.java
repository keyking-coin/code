...
public class SMSUtil {
	...
	public void init() {
		...
		//*******************************************************************************
		sms.init("sandboxapp.cloopen.com","8883");
		...
		//*******************************************************************************
		sms.setAppId("aaf98f894d7439d8014d7588721c01b1");
	}
	...
	//*********************************************************************************************************************
	public boolean send(String module,String num,String code){
		Map<?,?> datas = sms.sendTemplateSMS(num,module,new String[]{code,"5"});
	...
	public boolean sendPassword(String num,String code){
		Map<?,?> datas = sms.sendTemplateSMS(num,"1",new String[]{code});
		if ("000000".equals(datas.get("statusCode"))) {
			return true;
		}
		return false;
