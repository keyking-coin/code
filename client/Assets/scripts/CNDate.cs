...
namespace DotNet.Utilities
{
    ...
    public class ChinaDate
    {
        ...
        private static String[] nStr1 = new String[] { "", "正", "廿", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二" };
        ...
        private static String[] lFtv = new String[] { "0101春节", "0202龙抬头", "0115元宵", "0505端午", "0707七夕", "0815中秋", "0909重阳", "1208腊八", "1224小年", "0100除夕" };
        private static String[] sFtv = new String[] { "0101元旦","0214情人","0308妇女","0312植树","0501劳动","0504青年","0601儿童","0701建党","0801建军","0910教师","1001国庆","1225圣诞"};
