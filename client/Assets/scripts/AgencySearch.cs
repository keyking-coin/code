...
public class AgencySearch : MonoBehaviour
{
    public AgencyEvent agencyEvent = null;
    ...
    public void back()
    {
        ...
        transform.parent.FindChild("list").gameObject.SetActive(true);
    }

    public void openSearch()
    {
        gameObject.SetActive(true);
        transform.parent.FindChild("list").gameObject.SetActive(false);
    }
}
