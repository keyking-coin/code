...
import com.joymeng.slg.domain.advertisement.AdvertisementManager;
...
import com.joymeng.slg.domain.forbidden.ForbiddenManager;
...
import com.joymeng.slg.domain.object.redpacket.RedpacketManager;
...
public interface Instances {
	...
	public static final RedpacketManager rpManager = RedpacketManager.getInstance();
	...
	public static final ForbiddenManager forbidden = ForbiddenManager.getInstance();
	public static final GMServer gmSvr = GMServer.getInstance();
	public static final AdvertisementManager advSgr = AdvertisementManager.getInstance();
}
