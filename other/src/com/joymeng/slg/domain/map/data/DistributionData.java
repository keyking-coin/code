 ...
 *
 */
public class DistributionData implements DataKey {
	String id;
	String name;
	byte type;
	int centerX;
	...
	public int[][] computeTypeIndexs(){
		int[][] result = new int[2][needDistribution.size()];
		for (int i = 0 ; i < needDistribution.size() ; i++){
			MapEntiy entity = needDistribution.get(i);
			result[0][i] = i;
