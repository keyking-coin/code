...
public class ChatSystemContentType {
	// {0}已加入列表
	public static final String CHAT_CONTENT_HAS_JOINED_SESSION = "chat_content_has_joined_session";
	// {0}已退出群组
	public static final String CHAT_CONTENT_EXIT_GROUP		= "chat_content_exit_group";
	// {0}加入联盟
