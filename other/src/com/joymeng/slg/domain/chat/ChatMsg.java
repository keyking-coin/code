...
public class ChatMsg implements Cloneable {
	...
	private byte msgType;// 聊天类型 0：普通文字聊天 1:语音消息 2:系统消息 3:公告消息 6:系统聊天
	private byte reportType; //3 联盟邀请 //4 侦查报告//5 战斗报告//6 迁城邀请//7 系统邮件//8 敌人或资源采集
	...
	public ChatMsg(String msg,String msgColor, ChannelType channel, byte msgType, byte reportType, ChatRole sender, ChatRole receiver) {
		this.msg = msg;
	...
	public ChatMsg(String msgTitle, String msg,String msgColor, ChannelType channel, byte msgType, byte reportType, ChatRole sender, ChatRole receiver) {
	...
	public ChatMsg(long id, ChannelType channelType, String msg,String msgColor, byte msgType, byte reportType, ChatRole sender,
			ChatRole receiver, long sendDate, long groupId) {
		this.id = id;
