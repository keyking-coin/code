...
public class RemoveRoleBlacklistHandler extends ServiceHandler{
	...
	public JoyProtocol handle(UserInfo info, ParametersEntity params) throws Exception {
		...
		if(!role.removeRoleFromBlacklist(otherUid)){
			resp.fail();
			return resp;
		}
		MessageSendUtil.sendNormalTip(role.getUserInfo(), I18nGreeting.MSG_REMOVE_ROLE_BLACKLIST_SUC);
