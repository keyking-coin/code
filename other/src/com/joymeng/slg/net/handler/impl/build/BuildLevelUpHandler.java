...
public class BuildLevelUpHandler extends ServiceHandler {
	...
	public JoyProtocol handle(UserInfo info,ParametersEntity params) throws Exception {
		...
		if (role == null) {
			NewLogManager.misTakeLog("BuildLevelUpHandler getRole is null where uid = " + info.getUid());
			resp.fail();
			return resp;
		}
		...
		byte code = agent.BuildLevelup(role, id, money);
		if (code != 0) {
			resp.fail();
			resp.add(code);
		}
