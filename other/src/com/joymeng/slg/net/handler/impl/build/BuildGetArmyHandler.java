...
public class BuildGetArmyHandler extends ServiceHandler {
	...
	public JoyProtocol handle(UserInfo info,ParametersEntity params) throws Exception {
		...
		if (role == null){
			NewLogManager.misTakeLog("BuildGetArmyHandler getRole is null where uid = " + info.getUid());
			resp.fail();
			return resp;
		}
		...
		if (build == null){
			NewLogManager.misTakeLog("BuildGetArmyHandler getRoleBuild is null where uid = " + info.getUid());
			resp.fail();
