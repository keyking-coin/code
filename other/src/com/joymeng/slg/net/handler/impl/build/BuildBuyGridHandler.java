...
public class BuildBuyGridHandler extends ServiceHandler{
	@Override
...
//		params.put(in.getPrefixedString(JoyBuffer.STRING_TYPE_SHORT));//物品id
	...
	public JoyProtocol handle(UserInfo info,ParametersEntity params) throws Exception {
		...
		if (role == null){
			NewLogManager.misTakeLog("BuildBuyGridHandler getRole is null where uid = " + info.getUid());
			resp.fail();
			return resp;
		}
...
//		String itemId = params.get(2);
		...
		if(comGem == null || !comGem.buyItemSize(role, build)){
			resp.fail();
		}
		return resp;
	}
