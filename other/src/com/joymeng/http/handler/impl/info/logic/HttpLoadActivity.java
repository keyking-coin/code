...
public class HttpLoadActivity  extends AbstractHandler{
	@Override
	public String logic(HttpRequestMessage request) {
		...
		String loaderTime = request.getParameter("loaderTime");
		String loaderUrl = request.getParameter("loaderUrl");
		long uid = GameConfig.SYSTEM_TRANFOEM_ID; 
		int protocolId = 0x00000083; //  服务器远程下载压缩包
