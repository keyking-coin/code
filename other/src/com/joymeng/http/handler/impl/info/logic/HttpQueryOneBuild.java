...
public class HttpQueryOneBuild extends AbstractHandler {
	@Override
	public String logic(HttpRequestMessage request) {
		...
		if(isNum){
			...
			String slotId =request.getParameter("playerBuildSlot");
			...
			if (serList.contains(serverId)) {
				...
				int protocolId = 0x00000064; // 玩家指定建筑
