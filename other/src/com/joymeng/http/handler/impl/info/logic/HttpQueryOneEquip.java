...
public class HttpQueryOneEquip extends AbstractHandler{
	@Override
	public String logic(HttpRequestMessage request) {
		...
		if(isNum){
			...
			String equipId =request.getParameter("playerEquipId");  //装备数据库主键id
			...
			if (serList.contains(serverId)) {
				...
				int protocolId = 0x00000067; // 玩家指定装备
