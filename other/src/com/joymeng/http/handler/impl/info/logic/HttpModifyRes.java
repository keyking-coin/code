...
public class HttpModifyRes extends AbstractHandler{
	@Override
	public String logic(HttpRequestMessage request) {
		...
		if(isNum){
			...
			String resourceId = request.getParameter("playerResource");
			...
			if (serList.contains(serverId)) {
				...
				int protocolId = 0x00000062; // 修改玩家资源
