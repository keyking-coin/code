...
public class HttpModifyBuildState extends AbstractHandler{
	@Override
	public String logic(HttpRequestMessage request) {
		...
		if(isNum){
			...
			String  project =  request.getParameter("playerProject");
			...
			if (serList.contains(serverId)) {
				...
				int protocolId = 0x0000006B; // 修改玩家建筑状态等
