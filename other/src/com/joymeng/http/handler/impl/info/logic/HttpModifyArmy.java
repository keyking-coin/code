...
public class HttpModifyArmy  extends AbstractHandler{
	@Override
	public String logic(HttpRequestMessage request) {
		...
		if(isNum){
			...
			String armyId = request.getParameter("playerArmy");
			...
			if (serList.contains(serverId)) {
				...
				int protocolId = 0x00000063; // 修改玩家兵力
