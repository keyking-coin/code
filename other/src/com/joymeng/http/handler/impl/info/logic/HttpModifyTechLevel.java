...
public class HttpModifyTechLevel extends AbstractHandler{
	@Override
	public String logic(HttpRequestMessage request) {
		...
		if(isNum){
			...
			String techId = request.getParameter("playerTechId"); 
			...
			if (serList.contains(serverId)) {
				...
				int protocolId = 0x00000071; //  修改玩家科技等级
