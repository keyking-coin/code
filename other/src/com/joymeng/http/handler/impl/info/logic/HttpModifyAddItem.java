...
public class HttpModifyAddItem extends AbstractHandler{
	@Override
	public String logic(HttpRequestMessage request) {
		...
		if(isNum){
			...
			String itemId = request.getParameter("playerParameterSelect");
			...
			if (serList.contains(serverId)) {
				...
				int protocolId = 0x00000065; // 玩家添加物品
