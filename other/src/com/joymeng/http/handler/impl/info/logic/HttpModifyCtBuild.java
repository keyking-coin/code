...
public class HttpModifyCtBuild extends AbstractHandler{
	@Override
	public String logic(HttpRequestMessage request) {
		...
		if(isNum){
			...
			String  buildId =  request.getParameter("playerParameterSelect");
			...
			if (serList.contains(serverId)) {
				...
				int protocolId = 0x00000068; // 玩家新增建筑
