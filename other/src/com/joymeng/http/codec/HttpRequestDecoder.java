...
public class HttpRequestDecoder extends MessageDecoderAdapter {
	...
	private void decodeParams(Map<String, String[]> map, String strData) throws Exception{
		String[] match = strData.split("\\&");
		for (int i = 0 ; i < match.length ; i++){
			String element = match[i];
