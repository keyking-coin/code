...
start() {
    ...
    then
        ...
        nohup java -server -Xms2048m -Xmx2048m -Xmn512m -Xss256k -XX:PermSize=128M -XX:MaxPermSize=128M -XX:+AggressiveOpts -XX:+UseParallelGC -XX:+UseBiasedLocking -XX:NewSize=512m -Xdebug -Xrunjdwp:transport=dt_socket,address=52296,server=y,suspend=y -classpath $CLASSPATH com.joymeng.slg.ServiceApp > $APP_DIR/bin/console.log &
        newpid=$!
